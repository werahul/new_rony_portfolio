...
const Form = () => {
    ...
    return (
        <div className="lg:px-20  relative flex lg:flex-row-reverse flex-col-reverse lg:items-start lg:justify-between mt-20">
            ...
            {showPopup && (
                <div className="popup absolute top-0 lg:left-[5%] z-50 bg-[#641f6d] rounded-[50px]">
